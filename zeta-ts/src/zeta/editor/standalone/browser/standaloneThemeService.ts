...
import type { IStandaloneThemeData, IStandaloneThemeService } from '../common/standaloneTheme.js';

const ForcedColorsQuery = '(forced-colors: active)';

/** Owns named themes and the active theme for one standalone browser window. */
export class StandaloneThemeService extends ThemeService implements IStandaloneThemeService {
	...
	public defineTheme(themeId: string, themeData: IStandaloneThemeData): void {
