...
export class TypeWithoutInterceptorsOperation {
	public static getEdits(model: TextModel, selections: SelectionSet, edits: readonly SelectionEdit[], historyMode: EditorCommandHistoryMode): EditorEditCommand {
...
export class AutoClosingOvertypeOperation {
	public static getEdits(model: TextModel, selections: SelectionSet, text: string): EditorEditCommand {
...
function buildSelectionEditCommand(model: TextModel, selections: SelectionSet, replacements: readonly SelectionReplacement[], historyMode: EditorCommandHistoryMode): EditorEditCommand {
