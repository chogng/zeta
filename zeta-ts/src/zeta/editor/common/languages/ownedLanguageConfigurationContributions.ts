...
import { DEFAULT_LANGUAGE_AUTO_CLOSE_BEFORE, LanguageIndentAction, type LanguageAutoClosingPair, type LanguageCharacterPair, type LanguageConfigurationInput, type LanguageEnterAction, type LanguageFoldingMarkers, type LanguageIndentationRules, type LanguageOnEnterRule } from "./languageConfiguration.js";
...
export interface MergedLanguageConfiguration {
...
export interface LanguageConfigurationContributionInput {
	readonly languageId: string;
	readonly configuration: LanguageConfigurationInput;
...
export class MergedLanguageConfigurationChangeEvent {
	constructor(readonly languageId: string, readonly configuration: MergedLanguageConfiguration) {}
...
export interface LanguageConfigurationSource {
	readonly onDidChange?: Event<MergedLanguageConfigurationChangeEvent>;
...
export class OwnedLanguageConfigurationContributions extends Disposable implements LanguageConfigurationSource {
	private readonly changeEmitter = this._register(new Emitter<MergedLanguageConfigurationChangeEvent>());
	private readonly contributions = new Map<string, LanguageConfigurationContribution[]>();
	private readonly revisions = new Map<string, number>();
	private readonly resolved = new Map<string, MergedLanguageConfiguration>();
	private nextOrder = 1;

	readonly onDidChange: Event<MergedLanguageConfigurationChangeEvent> = this.changeEmitter.event;
	...
	register(languageId: string, configuration: LanguageConfigurationInput, options: LanguageConfigurationRegistrationOptions = {}): IDisposable {
	...
	private publishChange(languageId: string): void {
		...
		this.changeEmitter.fire(new MergedLanguageConfigurationChangeEvent(languageId, this.getLanguageConfiguration(languageId)));
	}
...
function normalizeLanguageConfiguration(configuration: LanguageConfigurationInput): NormalizedLanguageConfiguration {
...
function normalizeFoldingMarkers(markers: LanguageConfigurationInput["foldingMarkers"]): LanguageFoldingMarkers | null | undefined {
...
function normalizeIndentationRules(rules: LanguageConfigurationInput["indentationRules"]): LanguageIndentationRules | null | undefined {
...
function normalizeOnEnterRules(rules: LanguageConfigurationInput["onEnterRules"]): readonly LanguageOnEnterRule[] | null | undefined {
	if (rules === undefined || rules === null) return rules;
...
function normalizeComments(comments: LanguageConfigurationInput["comments"]): NormalizedLanguageCommentConfiguration | null | undefined {
...
function normalizeBrackets(brackets: LanguageConfigurationInput["brackets"]): readonly LanguageCharacterPair[] | null | undefined {
...
function resolveLanguageConfiguration(languageId: string, revision: number, contributions: readonly LanguageConfigurationContribution[]): MergedLanguageConfiguration {
...
export interface IComposableLanguageConfigurationService extends LanguageConfigurationSource, IDisposable {
	readonly _serviceBrand: undefined;
	readonly configurations: OwnedLanguageConfigurationContributions;
	readonly onDidChange: Event<MergedLanguageConfigurationChangeEvent>;
	register(languageId: string, configuration: LanguageConfigurationInput, options?: LanguageConfigurationRegistrationOptions): IDisposable;
	registerMany(contributions: readonly LanguageConfigurationContributionInput[]): LanguageConfigurationRegistration;
}

export const IComposableLanguageConfigurationService = createServiceIdentifier<IComposableLanguageConfigurationService>('languageConfigurationService');

/** Owns composable editing rules independently of language identities and providers. */
export class ComposableLanguageConfigurationService extends Disposable implements IComposableLanguageConfigurationService {
	readonly _serviceBrand = undefined;
	public readonly configurations = this._register(new OwnedLanguageConfigurationContributions());
	public readonly onDidChange = this.configurations.onDidChange;

	public register(languageId: string, configuration: LanguageConfigurationInput, options: LanguageConfigurationRegistrationOptions = {}): IDisposable {
	...
	public getLanguageConfiguration(languageId: string): MergedLanguageConfiguration {
