...
import { SemanticTokenModifier, SemanticTokenPresentation, type SemanticTokenStyling, type SemanticTokenStylingResolver } from './resolvedSemanticTokens.js';
...
export class LanguageTokenStylingResolver implements SemanticTokenStylingResolver {
