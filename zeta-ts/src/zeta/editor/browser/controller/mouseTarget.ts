...
function classifyElement(element: Element | undefined, editorDomNode: HTMLElement): ElementMouseTarget | undefined {
	...
	if (element.closest('.stanza-editor-zone-widget, .stanza-editor-view-zones, .stanza-editor-margin-view-zones')) return { kind: MouseTargetKind.ViewZone };
	...
	if (element.closest('.line-numbers')) return { kind: MouseTargetKind.LineNumber };
