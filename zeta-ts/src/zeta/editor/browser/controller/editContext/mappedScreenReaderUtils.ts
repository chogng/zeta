...
export interface MappedScreenReaderContentState {
...
interface IPagedScreenReaderStrategy<T> {
...
export class MappedScreenReaderStrategy implements IPagedScreenReaderStrategy<MappedScreenReaderContentState> {
	fromEditorSelection(model: TextModel, selection: Selection, linesPerPage: number, trimLongText: boolean): MappedScreenReaderContentState {
		...
		const mappingState: Pick<MappedScreenReaderContentState, 'value' | 'segments' | 'startOffset' | 'endOffset'> = {
			value,
			segments,
...
export function contentOffsetAtModelOffset(
	state: Pick<MappedScreenReaderContentState, 'segments' | 'startOffset' | 'endOffset'>,
	modelOffset: number,
