...
import { type ILineBreaksComputer, type LineBreaksResult } from '../../common/viewModel/viewModelLines.js';
 ...
 */
export class DOMLineBreaksComputer implements ILineBreaksComputer {
	public constructor(
	...
	public computeLineBreaksWithIndent(text: string, wrapWidth: number, wrappingIndent: WrappingIndent): LineBreaksResult {
