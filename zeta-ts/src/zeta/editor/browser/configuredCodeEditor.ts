...
import { type EditorRuler, type EditorTextDirection, type View, type EditorViewportPresentation } from './view.js';
...
export interface ConfiguredCodeEditorOptions {
	...
	readonly parameterHints?: IEditorOptions['parameterHints'];
...
export interface IConfiguredCodeEditor extends IDisposable {
...
export class ConfiguredCodeEditor extends Disposable implements IConfiguredCodeEditor {
	...
	constructor(options: ConfiguredCodeEditorOptions) {
		super();
		try {
...
function validateOptions(options: ConfiguredCodeEditorOptions): void {
