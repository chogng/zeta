...
registerTextEditorCapabilityContribution({ id: "editor.contrib.linesOperations", commands: [
	...
	context.register(new LineOperationsController(context.view.element, context.viewport, context.viewModel, { indentation: context.options.indentation, executeCommand: context.executeCommand }));
	context.register(new LineJoinController(context.view.element, context.viewport, context.viewModel, { executeCommand: context.executeCommand }));
} });
