...
export class EditorInteractionStateStore extends Disposable {
	private readonly changeEmitter = this._register(new Emitter<EditorInteractionState>());
	private state: EditorInteractionState;
	readonly onDidChange: Event<EditorInteractionState> = this.changeEmitter.event;
	...
	private update(partial: Partial<EditorInteractionState>): void {
