...
import { LanguageTokenLineIndexPart } from "../../tokenization/common/languageTokenLineIndexPart.js";
...
registerTextEditorCapabilityContribution({
	...
	configure: context => {
		...
		const tokenization = context.register(new LanguageTokenLineIndexPart(new LanguageTokenLineIndex(syntax.tokens)));
