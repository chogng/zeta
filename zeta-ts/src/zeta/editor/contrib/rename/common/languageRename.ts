...
export class RenameService extends Disposable {
	constructor(private readonly model: TextModel, private readonly resource: URI, private readonly providers: OwnedLanguageFeatureProviderRegistry<LanguageRenameProvider>) {
		super();
	}
