	...
	},
	{
		...
		groups: [
			...
			},
			{
				...
				settings: ['breadcrumbs.enabled', 'editor.wordWrap', 'editor.wrappingIndent', 'editor.lineNumbers', 'editor.guides.*', 'editor.bracketPairColorization.*', 'editor.stickyScroll.*', 'editor.highlightActiveLine', 'editor.unicodeHighlights'],
			},
			{
				id: 'minimap',
				label: 'Minimap',
