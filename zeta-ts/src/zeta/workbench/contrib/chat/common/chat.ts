...
export const CHAT_AGENT_SIDEBAR_VIEW_CONTAINER_ID = "zeta.chat.agentSidebar";
export const CHAT_AGENT_SIDEBAR_VIEW_ID = "zeta.chat.agentSidebar.view";
...
export const TOGGLE_AGENT_SIDEBAR_COMMAND_ID =
	"workbench.action.chat.toggleAgentSidebar";
