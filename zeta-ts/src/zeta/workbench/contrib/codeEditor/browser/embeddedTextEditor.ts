...
import { type IEmbeddedTextEditor, type EmbeddedTextEditorOptions, type IEmbeddedTextEditorFactory } from "../../../../editor/browser/widget/embeddedTextEditor.js";
...
class EmbeddedTextEditor extends DisposableOwner implements IEmbeddedTextEditor {
	...
	private readonly pane: CodeEditorPane;
	...
	constructor(options: EmbeddedTextEditorOptions, factoryOptions: EmbeddedTextEditorFactoryOptions) {
		...
		this.pane = this.own(new CodeEditorPane(this.resourceStore, {
