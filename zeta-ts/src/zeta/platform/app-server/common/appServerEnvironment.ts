...
const PRODUCT_ENVIRONMENT_KEYS = ["ZETA_APP_SERVER_PATH", "ZETA_APP_SERVER_SHA256", "ZETA_ELECTRON_RUN_AS_NODE_PATH", "ZETA_PRODUCT_SERVICES_PATH", "ZETA_PROFILE_ROOT", "ZETA_RG_PATH", "ZETA_WORKSPACE_ROOT", "ZETA_DIR_GRANT_SOURCE"] as const;
