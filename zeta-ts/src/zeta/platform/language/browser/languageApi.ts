...
export function createViteDevLanguageApi(connection: ViteDevAppServerConnection): ILanguageApi {
	return {
		...
		directoryDiagnostics: (params, options) => viteDevRequest(connection, "language/directoryDiagnostics", params, options),
		...
		directorySymbols: (params, options) => viteDevRequest(connection, "language/directorySymbols", params, options),
