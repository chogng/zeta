//! Product-level Composer state, editing, interaction, and geometry for app.
//!
//! The crate owns Composer-local text editing, automatic Agent/Shell routing, completion,
//! interaction state, and layout. The app host retains Thread/catalog adaptation, submission
