...
2. Owns one Agent Session Pane: Thread metadata and header wrap a ChatWidget containing the transcript timeline and a ChatInputPane; the pane combines ChatInput, its toolbar, and the input-only interaction area used by Slash Commands and model selection.
