...
use zui::ui::{
    ...
    FontWeight, PaintRect, Point, Rect, Size, TextBlock, TextInputLayoutEngine, TextStyle,
};
...
use crate::interaction::{
    COMPOSER, COMPOSER_INFO_BAR, COMPOSER_INTERACTION, COMPOSER_PANEL, composer_interaction_item_id,
};
...
#[derive(Clone, Copy)]
pub struct ComposerPanelView<'a> {
    pub context: &'a SessionPaneContext,
    pub editor: &'a ComposerInput,
    pub interaction: &'a ComposerInteractionModel,
    pub interaction_pane: &'a ComposerInteractionPaneState,
