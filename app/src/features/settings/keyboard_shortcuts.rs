...
pub(crate) type KeyboardShortcutsState = GenericKeyboardShortcutsState<AppCommandId>;
...
) -> Vec<KeyboardShortcutRow<'_, AppCommandId>> {
...
pub(super) fn row_element(command: AppCommandId) -> ElementId {
...
fn command_for_row(id: ElementId) -> Option<AppCommandId> {
    AppCommandId::BINDABLE
        .into_iter()
