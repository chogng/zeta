//! Sidebar Sessions toolbar tests.

use super::{SessionsToolbar, TOOLBAR_HEIGHT};
use crate::sidebarpart::identity::{ADD_SESSION, SESSION_SEARCH_INPUT, TAB_CONTAINER_ACTION_BAR};
