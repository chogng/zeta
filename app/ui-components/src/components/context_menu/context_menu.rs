use crate::{
    BoxShadow, Color, Component, ComponentContext, ComponentElement, ContextView,
    ContextViewPlacement, ContextViewStyle, CornerRadii, Edges, Element, PaintRect, Point, Rect,
    Size, UiScene,
};
...
impl ContextMenu {
    ...
    /// Composes the canonical menu shell and a product-owned header through one shared context.
    pub fn draw_components_with_header(
        ...
        context.with_element(self.element_tree(), |context, _element| {
            ...
            self.context_view
                .draw_components_overflow(context, |context, _content_bounds| {
