//! Settings navigation and action-bar presentation helpers.
...
pub(super) struct SettingsPageActionState {
    reset: ButtonState,
    save: ButtonState,
}

impl SettingsPageActionState {
    pub(super) fn from_availability(
    ...
    pub(super) const fn reset(self) -> ButtonState {
        self.reset
    }

    pub(super) const fn save(self) -> ButtonState {
        self.save
    }
}
...
pub(super) fn navigation_buttons(
    ...
    [
        ...
        navigation_button(
            ...
            icons::CODE,
            "Language Servers",
            section == SettingsPageSection::LanguageServers,
            dispatch,
            style,
        ),
        navigation_button(
