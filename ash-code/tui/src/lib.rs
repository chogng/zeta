...
use ash_app_server_client::TakeEventsError;
...
pub fn update_policy(
    section: &ash_app_server_protocol::protocol::config::FrontendConfigDto,
...
impl TuiOptions {
    ...
    /// Enables Ash Code theme documents from the active profile.
