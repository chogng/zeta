    ...
    vec![
        ...
        DetailListRow::new(
            ...
            match session.status {
                zeta_protocol::SessionStatus::Active => "active",
                zeta_protocol::SessionStatus::Archived => "archived",
            },
        ),
        DetailListRow::new(
            "Status",
...
pub(crate) fn load_details<T: zeta_app_server_client::JsonRpcTransport>(
    ...
    super::Event::DetailsReceived {
        ...
        result: client
            .read_session(
                zeta_app_server_protocol::protocol::session::SessionReadParams { session_id },
            )
