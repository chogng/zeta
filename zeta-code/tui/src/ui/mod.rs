...
pub(crate) use theme::apply_theme;
...
pub(crate) use theme::highlight;
pub(crate) use theme::muted;
pub(crate) use theme::prepare_theme;
pub(crate) use theme::success;
pub(crate) use theme::theme_catalog;
pub(crate) use theme::warning;
