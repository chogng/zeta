...
/// Planning scope used to keep GitHub Issue work items from writing the same resources.
#[derive(Clone, Debug, Default, Deserialize, Eq, PartialEq, Serialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct IssueWorkScope {
...
impl IssueWorkItem {
    ...
    pub fn conflicts_with(&self, other: &Self) -> bool {
        let empty = |scope: &IssueWorkScope| {
...
/// Durable Issue membership and provisioning receipts; execution belongs to Session Threads.
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
