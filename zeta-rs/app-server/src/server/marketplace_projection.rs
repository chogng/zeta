...
use zeta_core_plugins::AcquiredCapability;
use zeta_core_plugins::ActivationSpec;
use zeta_core_plugins::ArtifactHandle;
use zeta_core_plugins::AvailableCapability;
use zeta_core_plugins::CapabilityDescriptor;
use zeta_core_plugins::CapabilityKind;
use zeta_core_plugins::CapabilityLease;
use zeta_core_plugins::CapabilityRef;
use zeta_core_plugins::ConnectorActivationSpec;
use zeta_core_plugins::ExecutableActivationSpec;
use zeta_core_plugins::ExecutableRuntime;
use zeta_core_plugins::InstallationState;
use zeta_core_plugins::InstalledPackage;
use zeta_core_plugins::LanguageActivationSpec;
use zeta_core_plugins::LocalizationActivationSpec;
use zeta_core_plugins::McpActivationSpec;
use zeta_core_plugins::McpTransportSpec;
...
use zeta_core_plugins::ResourceContent;
use zeta_core_plugins::ResourceRef;
use zeta_core_plugins::SearchPackagesResult;
use zeta_core_plugins::SkillActivationSpec;
use zeta_core_plugins::ThemeActivationSpec;
use zeta_core_plugins::UpstreamReference;
use zeta_core_plugins::UpstreamRegistry;
