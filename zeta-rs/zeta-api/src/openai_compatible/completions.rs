use crate::{
    ApiError, ContentPart, ImageDetail, InputItem, JsonHttpTransport, Message, MessageRole,
    ModelRequest, ModelResponse, ModelUsage, OutputItem, ReasoningEffort, ResolvedApiTarget,
