use crate::{
    ApiError, ContentPart, ImageDetail, InputItem, JsonHttpTransport, MessageRole, ModelRequest,
    ModelResponse, ModelUsage, OutputItem, ReasoningEffort, ResolvedApiTarget, StopReason,
