...
#[serde(rename_all = "camelCase")]
pub struct SymbolIndexStatusResult {
    pub state: SymbolIndexStateDto,
    pub root_id: String,
    #[ts(type = "number")]
    pub generation: u64,
    #[ts(type = "number")]
...
#[derive(Clone, Debug, Deserialize, Eq, JsonSchema, PartialEq, Serialize, TS)]
#[serde(rename_all = "camelCase")]
pub struct SymbolIndexSearchParams {
...
#[derive(Clone, Debug, Deserialize, Eq, JsonSchema, PartialEq, Serialize, TS)]
#[serde(rename_all = "camelCase")]
pub struct SymbolIndexSearchHitDto {
    pub name: String,
...
#[derive(Clone, Debug, Deserialize, Eq, JsonSchema, PartialEq, Serialize, TS)]
#[serde(rename_all = "camelCase")]
pub struct SymbolIndexSearchResult {
    pub status: SymbolIndexStatusResult,
    pub hits: Vec<SymbolIndexSearchHitDto>,
