...
use crate::protocol::config::{
    ...
    CodeProductPreferencesUpdateDto, ConfigChanged, ConfigCommandDispositionDto,
    ConfigCommandResult, ConfigReadResult, ConfigUpdateParams, DesktopProductPreferencesDto,
    DesktopProductPreferencesUpdateDto, HookActionDto, HookConfigDto, HookEnablementDto,
    HookEventDto, HookMatcherDto, HookRemoveParams, HookSetEnablementParams, HookUpsertParams,
    LanguageServerConfigDto, LanguageServerConfigureParams, LanguageServerModeDto,
    LanguageServerRemoveParams, McpCredentialBindingDto, McpServerConfigDto,
    ...
    PluginRequestUpsertParams, ProductsConfigDto, ProductsConfigUpdateDto, ProviderConfigDto,
    ...
    ToolSearchModeDto, ZetermProductPreferencesDto, ZetermProductPreferencesUpdateDto,
};
...
typescript_bindings! {
    ...
    ConfigCommandResult,
    ConfigUpdateParams,
    AutomaticPreferenceDto,
    DesktopProductPreferencesDto,
    CodeProductPreferencesDto,
    ZetermProductPreferencesDto,
    ProductsConfigDto,
    DesktopProductPreferencesUpdateDto,
    CodeProductPreferencesUpdateDto,
    ZetermProductPreferencesUpdateDto,
    ProductsConfigUpdateDto,
