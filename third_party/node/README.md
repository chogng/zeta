...
Ash packages one shared Node.js runtime for package-provided JavaScript language servers. Language
...
them at `ash-resources/node/bin/node[.exe]` and `ash-resources/licenses/node/LICENSE`.
