...
| `chat.tabBackground` | chat.presentation | `#f8f8f8` | `#f8f8f8` | `--zeta-chat-tab-background` |
| `chat.tabActiveBackground` | chat.presentation | `#eeeeee` | `#eeeeee` | `--zeta-chat-tab-active-background` |
...
| `editor.background` | workbench.shell | `#ffffff` | `#ffffff` | `--zeta-editor-background` |
| `editor.foreground` | workbench.shell | `#333333` | `#333333` | `--zeta-editor-foreground` |
...
| `terminal.background` | terminal.presentation | `#ffffff` | `#ffffff` | `--zeta-terminal-background` |
| `terminal.foreground` | terminal.presentation | `#333333` | `#333333` | `--zeta-terminal-foreground` |
...
| `terminal.ansiWhite` | terminal.presentation | `#333333` | `#333333` | `--zeta-terminal-ansi-white` |
