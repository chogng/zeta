...
| `settings.focusedRowBackground` | workbench.preferences | `#2a2d2e99` | `#e8e8e899` | `--zeta-settings-focused-row-background` |
| `settings.rowHoverBackground` | workbench.preferences | `#2a2d2e4d` | `#e8e8e84d` | `--zeta-settings-row-hover-background` |
