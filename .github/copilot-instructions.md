...
- Use the smallest typecheck, test, build, or documentation check that covers the changed surface. Do not report a command as passing unless it completed successfully.
