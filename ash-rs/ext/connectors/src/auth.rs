...
const AUTH_COMMAND_DOMAIN: &[u8] = b"ash-connector-auth-command-v1\0";
const CREDENTIAL_KEY_DOMAIN: &[u8] = b"ash-connector-credential-key-v1\0";
const OAUTH_CREDENTIAL_MAGIC: &[u8] = b"ash-oauth-credential-v1\0";
