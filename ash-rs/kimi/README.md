...
`ash-kimi` 是 Kimi Code 订阅的本机认证 owner。它实现 device authorization、token polling、refresh、SecretStore envelope、provider-scoped logout 和构造 Kimi Coding API 所需的 authenticated `ResolvedApiTarget`。
