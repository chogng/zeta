//! Cancellation and caller-owned identity checks for queued device operations.
...
/// Invalidates queued work and suppresses late results. Platform providers observe cancellation
