...
> 本 README 拥有按 Turn 归属的 Git 变更集领域契约；工作树和 Git 原语分别由 [`worktree`](../worktree/README.md) 与 [`ash-git`](../git/README.md) 拥有，跨组件产品语义见 [`docs/chat-session-inspector.md`](../../docs/chat-session-inspector.md)。
