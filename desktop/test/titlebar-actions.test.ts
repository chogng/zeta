...
import type {
  IMenubarControl,
} from "../src/zeta/workbench/browser/parts/titlebar/menubarControl.js";
...
const { DisposableStore, toDisposable } = await import(
  "../src/zeta/base/common/lifecycle.js"
);
...
const { CommandsRegistry } = await import(
  "../src/zeta/platform/commands/common/commands.js"
);
const { ContextKeyService } = await import(
  "../src/zeta/platform/contextkey/common/contextkey.js"
);
...
const { BrowserTitlebarPart } = await import(
  "../src/zeta/workbench/browser/parts/titlebar/titlebarPart.js"
);
const { BrowserMenubarControl } = await import(
  "../src/zeta/workbench/browser/parts/titlebar/menubarControl.js"
);
