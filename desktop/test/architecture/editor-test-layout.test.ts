...
test("editor unit tests follow the flat common, browser, and contrib layout", () => {
...
test("editor browser integration is flat and named after concrete model mount points", () => {
