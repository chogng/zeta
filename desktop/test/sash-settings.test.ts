...
const { IConfigurationService } = await import("../src/zeta/platform/configuration/common/configuration.js");
const { WorkbenchContributionsRegistry, WorkbenchPhase } = await import("../src/zeta/workbench/common/contributions.js");
const { IWorkbenchWindowService } = await import("../src/zeta/workbench/browser/window.js");
const { SashConfiguration } = await import("../src/zeta/workbench/contrib/sash/common/sash.js");
const { SashSettingsController } = await import("../src/zeta/workbench/contrib/sash/browser/sash.js");
...
await import("../src/zeta/workbench/contrib/sash/browser/sash.contribution.js");
