...
import type { IInstantiationService } from "../src/zeta/platform/instantiation/common/instantiation.js";
import type { IViewContainerDescriptor, IViewContainerModel } from "../src/zeta/workbench/common/views.js";
...
const { toDisposable } = await import("../src/zeta/base/common/lifecycle.js");
const { ContextKeyService } = await import("../src/zeta/platform/contextkey/common/contextkey.js");
const { ViewContainerLocation } = await import("../src/zeta/workbench/common/views.js");
const { ViewPaneContainer } = await import("../src/zeta/workbench/browser/parts/views/viewPaneContainer.js");
