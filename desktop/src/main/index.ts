...
import { AppServerProcess } from "./app-server/app-server-process.js";
...
app.whenReady().then(async () => {
  ...
  const window = new BrowserWindow({ webPreferences: { contextIsolation: true, nodeIntegration: false, sandbox: true, preload: join(import.meta.dirname, "../preload/index.js") } });
