...
export class WorkbenchConfigurationService
  ...
  #acceptSnapshot(snapshot: IConfigurationSnapshot): void {
  ...
  #applySnapshot(snapshot: IConfigurationSnapshot): void {
  ...
  #assertRegistered<T>(key: IConfigurationKey<T>): void {
