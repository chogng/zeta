import type { PluginCommandResultDto, PluginListResult, PluginMarketplaceListResult } from "../../../../../generated/app-server/types.js";
...
export function createPluginApi(): IPluginApi {
  return {
    ...
    listMarketplace: () => invoke<PluginMarketplaceListResult>("zeta:plugins:marketplace-list"),
    install: params => invoke<PluginCommandResultDto>("zeta:plugins:install", params),
    update: params => invoke<PluginCommandResultDto>("zeta:plugins:update", params),
    rollback: params => invoke<PluginCommandResultDto>("zeta:plugins:rollback", params),
