...
const PRODUCT_ENVIRONMENT_KEYS = ["ZETA_ELECTRON_RUN_AS_NODE_PATH", "ZETA_PRODUCT_SERVICES_PATH", "ZETA_PROFILE_ROOT", "ZETA_RG_PATH", "ZETA_WORKSPACE_ROOT", "ZETA_WORKSPACE_TRUST_SOURCE"] as const;
