import type { ModelListResult, SessionListResult, SessionResult, SessionSubscribeResult, SessionThreadResult, ThreadReadResult, ThreadSubscribeResult, TurnInteractionResolveResult, TurnInterruptResult, TurnStartResult } from "../../../../../generated/app-server/types.js";
...
export function createThreadApi(): IThreadApi {
  return {
    read: (params) => invoke<ThreadReadResult>("zeta:thread:read", params),
    subscribe: (params) => invoke<ThreadSubscribeResult>("zeta:thread:subscribe", params),
