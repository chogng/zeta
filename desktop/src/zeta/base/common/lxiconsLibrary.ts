...
export const lxiconsLibrary = {
  ...
  discard: register("discard", svg.discard),
  ...
  github: register("github", svg.github),
  ...
  pinned: register("pinned", svg.pinned),
  refresh: register("refresh", svg.refresh),
  remove: register("remove", svg.remove),
  ...
  unfold: register("unfold", svg.unfold),
