...
import { type DocumentMarkSpec, type DocumentNodeSpec, DocumentSchema, createDefaultDocumentSchema } from "../../common/schema.js";
import { BIBLIOGRAPHY_NODE_TYPE, bibliographyNodeSpec, CITATION_NODE_TYPE, citationNodeSpec, REFERENCE_NODE_TYPE, referenceNodeSpec } from "../../contrib/citation/common/schema.js";

/** Node types owned by Gamma's Academic document profile. */
...
/** Creates the Academic schema while retaining Gamma's default document nodes. */
