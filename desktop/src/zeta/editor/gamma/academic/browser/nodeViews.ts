...
import type { DocumentNodeViewContext, DocumentNodeViewFactory } from "../../browser/documentEditorPane.js";

/** Browser projections for Academic wrapper nodes; child editing stays Gamma-owned. */
...
function createWrapper(context: DocumentNodeViewContext, tagName: "header" | "section", role: string, label?: string): HTMLElement {
