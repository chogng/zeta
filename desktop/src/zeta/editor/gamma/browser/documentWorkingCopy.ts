...
import { documentFromPlainText } from "../common/documentText.js";
...
import { DocumentSerializationError, deserializeDocument, serializeDocument } from "../common/serialization.js";
...
/** Persistence adapter for Gamma's immutable document model. */
...
/** Parses Gamma's versioned format and migrates plain text into paragraphs. */
