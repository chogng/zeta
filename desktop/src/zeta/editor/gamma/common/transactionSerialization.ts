...
import { decodeDocumentNode, DocumentSerializationError, encodeDocumentNode, type SerializedDocumentNode } from "./serialization.js";
import { type DocumentSchema } from "./schema.js";
import { allSelection, nodeSelection, textSelection, type DocumentPoint, type DocumentSelection } from "./selection.js";
import { DocumentTransaction, type DocumentStep, type DocumentTransactionMetaEntry, type DocumentTransactionOptions } from "./transaction.js";
...
/** Serializes a Gamma transaction into a versioned, JSON-safe transport envelope. */
...
/** Parses and validates a versioned Gamma transaction transport envelope. */
