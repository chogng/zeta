import type { DocumentDecorationSet } from "./decoration.js";
...
import type { DocumentTransaction } from "./transaction.js";

/** Origins that a document plugin can observe when Gamma advances its state. */
...
/** A common-state extension that is updated atomically with Gamma document changes. */
...
/** Creates a validated immutable plugin descriptor for a Gamma document model. */
