...
import { type DocumentSchema, type DocumentValidationOptions } from "./schema.js";
...
/** JSON-safe representation of one Gamma node, including incomplete transaction fragments. */
...
/** Decodes and validates one untrusted node value from a Gamma transport payload. */
...
/** Serializes a validated selection fragment for Gamma-aware clipboard transport. */
...
/** Parses and validates a Gamma clipboard fragment without trusting its JSON shape. */
