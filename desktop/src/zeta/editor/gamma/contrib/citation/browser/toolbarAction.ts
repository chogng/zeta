...
import type { DocumentEditorToolbarAction } from "../../../browser/documentEditorPane.js";

/** Toolbar actions contributed by the citation capability. */
export const citationToolbarActions: readonly DocumentEditorToolbarAction[] = Object.freeze([
  {
    id: "citation",
    label: "Citation",
    run: context => {
