...
import type { DocumentInlineNodeViewFactory, DocumentNodeViewContext, DocumentNodeViewFactory } from "../../../browser/documentEditorPane.js";

/** Block projections owned by the citation capability. */
export const nodeViews: Readonly<Record<string, DocumentNodeViewFactory>> = Object.freeze({
...
export const inlineNodeViews: Readonly<Record<string, DocumentInlineNodeViewFactory>> = Object.freeze({
...
function createWrapper(context: DocumentNodeViewContext, tagName: "section", role: string, label: string): HTMLElement {
