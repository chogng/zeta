...
export class AlphaTokenizationController extends DisposableOwner {
  constructor(private readonly viewport: AlphaEditorViewport, private readonly tokenization: TokenizationTextModelPart) {
    super();
