...
import { findUnicodeHighlights, type AlphaUnicodeHighlight } from "../common/unicodeHighlighter.js";

/** Maintains Unicode warning ranges as a feature-owned decoration collection. */
export class AlphaUnicodeHighlighterController extends DisposableOwner {
  private lastVersion = -1;

  constructor(private readonly model: TextModel, readonly decorations: TextDecorationCollection<AlphaUnicodeHighlight>) {
    super();
