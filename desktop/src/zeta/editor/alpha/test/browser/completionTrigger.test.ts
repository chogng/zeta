...
import { LanguageCompletionProviderRegistry, LanguageCompletionTriggerKind, type LanguageCompletionProvider, type LanguageCompletionProviderRequest, type LanguageCompletionProviderResult } from "../../language/common/languageCompletionProviders.js";
...
function createFixture(provider: LanguageCompletionProvider, text = "con"): TriggerFixture {
  ...
  const builtinConfigurations = registerAlphaBuiltinLanguageConfigurations(configurations);
