...
import { getAlphaPointerAutoScrollVelocity } from "../../../browser/input/pointerAutoScroll.js";
...
test("Pointer autoscroll velocity follows overflow on each axis", () => {
  assert.deepEqual(
    getAlphaPointerAutoScrollVelocity(bounds, {
      clientX: 200,
      clientY: 100,
    }),
    { left: 0, top: 0 },
...
test("Pointer autoscroll velocity validates bounds and points", () => {
  assert.throws(() => getAlphaPointerAutoScrollVelocity(
    { ...bounds, right: 50 },
