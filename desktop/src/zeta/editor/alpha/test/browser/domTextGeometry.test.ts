...
const { createAlphaDomTextRange, getAlphaDomTextCaretLeft, getAlphaDomTextOffsetAtClientPoint, getAlphaDomTextRangeRectangles } = await import("../../browser/domTextGeometry.js");
