...
import { AlphaPointerMultiCursorModifier } from "../../browser/pointerMultiCursor.js";
...
const { AlphaPointerSelectionController } = await import("../../browser/pointerSelectionController.js");
