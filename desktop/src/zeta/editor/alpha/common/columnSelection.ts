...
/**
 * Creates one same-column selection per physical line between two editor positions.
 *
 * Columns are clamped independently at every line end. Alpha deliberately does
