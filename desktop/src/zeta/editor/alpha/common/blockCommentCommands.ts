...
import { TextPosition, TextRange, type TextEdit } from "./text.js";
...
export function createToggleBlockCommentCommand(model: TextModel, selections: TextSelectionSet, options: EditorBlockCommentOptions): EditorEditCommand {
