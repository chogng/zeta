import { type EditorEditCommand, type TextSelectionOffsets } from "./editorSelectionController.js";
import { normalizeTextLineEndings, TextRange, type TextModelChange } from "./text.js";
