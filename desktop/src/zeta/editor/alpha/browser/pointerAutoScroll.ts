...
import { type AlphaClientPoint, type AlphaEditorHitTarget } from "./pointerHitTest.js";
...
function validatePoint(point: AlphaClientPoint): void {
  if (
    ...
    throw new RangeError("Alpha autoscroll point must contain finite coordinates");
  }
}
...
function validateBounds(bounds: AlphaPointerAutoScrollBounds): void {
  if (
    ...
    throw new RangeError("Alpha autoscroll bounds are invalid");
  }
}
