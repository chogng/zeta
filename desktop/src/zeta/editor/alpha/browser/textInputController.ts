...
import { type LanguageConfigurationSource, type ResolvedLanguageConfiguration } from "../language/common/languageConfiguration.js";
import { type LanguageCompletionSessionController } from "../language/common/languageCompletionSession.js";
import { type LanguageCompletionService } from "../language/common/languageCompletionService.js";
import { createLanguageCompletionIncompleteRefreshContext, createLanguageCompletionInvokeContext, type LanguageCompletionContext } from "../language/common/languageCompletionProviders.js";
import { assertLanguageId } from "../language/common/languageId.js";
import { createLanguageEnterCommand } from "../language/common/languageEnter.js";
import { LanguageLexicalContextIndex, type LanguageLexicalContextSource } from "../language/common/languageLexicalContext.js";
import { createLanguagePairBackspaceCommand, createLanguagePairTypeCommand, type LanguagePairTypeCommand } from "../language/common/languagePairEditing.js";
...
import { AlphaCompletionWidget } from "../language/browser/completionWidget.js";
