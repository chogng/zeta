import { createSelectionEditCommand, getPreviousDeleteRange, type EditorSelectionEdit } from "../../common/editCommands.js";
import { EditorCommandHistoryMode, type EditorEditCommand } from "../../common/editorSelectionController.js";
import { type LanguageAutoClosingPair, type LanguageCharacterPair, type ResolvedLanguageConfiguration } from "./languageConfiguration.js";
import { type LanguageLexicalContextSource } from "./languageLexicalContext.js";
import { type TextSelection, type TextSelectionSet } from "../../common/selection.js";
