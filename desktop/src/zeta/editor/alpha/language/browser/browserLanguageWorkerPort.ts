...
import { type LanguageWorkerWireClientPort } from "../common/languageWorkerWire.js";

/** Owns one browser Worker and adapts it to Alpha's structural wire port. */
export class BrowserLanguageWorkerPort extends DisposableOwner implements LanguageWorkerWireClientPort {
  ...
  constructor(private readonly worker: Worker) {
    ...
    const onMessageError = (): void => this.failureEmitter.fire(new TypeError("Alpha language Worker returned an unreadable message"));
