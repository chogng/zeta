...
/** JSON-safe representation of one Gama node, including incomplete transaction fragments. */
...
/** Decodes and validates one untrusted node value from a Gama transport payload. */
...
/** Serializes a validated selection fragment for Gama-aware clipboard transport. */
...
/** Parses and validates a Gama clipboard fragment without trusting its JSON shape. */
