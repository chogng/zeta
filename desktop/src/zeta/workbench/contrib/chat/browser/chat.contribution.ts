...
import { CHAT_VIEW_CONTAINER_ID, CHAT_VIEW_ID, NEW_CHAT_COMMAND_ID, OPEN_CHAT_COMMAND_ID, SHOW_CHAT_HISTORY_COMMAND_ID } from "../common/chat.js";
...
registerAction2(class ShowChatHistoryAction extends Action2 {
  ...
  override run(accessor: ServicesAccessor): void {
    ...
    const quickPick = accessor.get(IQuickInputService)
      .createQuickPick<ChatHistoryQuickPickItem>();
