...
function unavailableChatService(): IChatService {
  ...
  return {
    ...
    readThread: (_threadId: ThreadId) => pending as Promise<Thread>,
    subscribeThread: (_threadId: ThreadId, _afterSequence: number) => pending as Promise<ThreadSubscription>,
    unsubscribeThread: (_threadId: ThreadId) => pending as Promise<void>,
