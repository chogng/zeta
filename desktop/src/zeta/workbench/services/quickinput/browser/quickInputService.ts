...
export class WorkbenchQuickInputService
  ...
  readonly #inQuickInput: IContextKey<boolean>;
  readonly #quickPicks = new Set<IBrowserQuickPickHost>();
  #active: IBrowserQuickPickHost | undefined;
  ...
  #show(quickPick: IBrowserQuickPickHost): void {
  ...
  #hide(quickPick: IBrowserQuickPickHost): void {
