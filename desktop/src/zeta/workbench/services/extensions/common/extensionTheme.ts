...
export class ExtensionThemeRegistry extends DisposableOwner {
...
function normalizeTheme(theme: ExtensionThemeDefinition): ExtensionThemeDefinition {
  ...
  return Object.freeze({
    ...
    ...(theme.uiTheme === undefined ? {} : { uiTheme: boundedText(theme.uiTheme, "Extension theme UI theme", 128) }),
...
function parseTokenColorSettings(value: unknown, owner: string): ExtensionThemeTokenColorSettings {
  ...
  return Object.freeze({
    ...
    ...(settings.fontStyle === undefined ? {} : { fontStyle: boundedText(settings.fontStyle, `${owner}.fontStyle`, 128) }),
  });
}
...
function normalizeTokenColors(value: readonly ExtensionThemeTokenColorRule[]): readonly ExtensionThemeTokenColorRule[] {
  ...
  return Object.freeze(value.map(rule => Object.freeze({
    scopes: Object.freeze([...rule.scopes]),
    settings: Object.freeze({ ...rule.settings }),
  })));
}

function colorValue(value: unknown, owner: string): string {
  return boundedText(value, owner, 128);
}
