...
import { addDisposableListener, reset, } from "./dom.js";
import { sanitizeHtmlToFragment, } from "./domSanitize.js";
...
export class MarkdownElement extends DisposableOwner {
    ...
    setMarkdown(markdown) {
        ...
        reset(this.element, sanitizeMarkdownHtmlToFragment({
...
export function renderWorkbenchMarkdown(markdown, breaks = false) {
...
export function sanitizeMarkdownHtmlToFragment(options, rawHtml) {
...
export function sanitizeMarkdownHtmlToString(options, rawHtml) {
...
function applyMarkdownAttributePolicy(element) {
...
function validateRawHtml(rawHtml) {
