...
import { operatingSystemFromNodePlatform, operatingSystemFromUserAgent, } from "../../common/environment.js";
...
test("operatingSystemFromUserAgent recognizes browser hosts", () => {
    assert.equal(operatingSystemFromUserAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64)"), "windows");
    assert.equal(operatingSystemFromUserAgent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)"), "mac");
    assert.equal(operatingSystemFromUserAgent("Mozilla/5.0 (X11; Linux x86_64)"), "linux");
