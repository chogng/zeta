...
import { matchProseMirrorEditor, } from "../common/proseMirrorEditorInput.js";
import { createProseMirrorEditorState, proseMirrorDocumentSchema, } from "../common/proseMirrorEditorState.js";
test("ProseMirror defaults structured Academic documents", () => {
    assert.equal(matchProseMirrorEditor({
