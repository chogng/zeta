...
export function matchMonacoEditor(input) {
...
export function monacoLanguageForInput(input) {
    const contentTypeLanguage = CONTENT_TYPE_LANGUAGES.get(input.contentType ?? "");
    if (contentTypeLanguage)
