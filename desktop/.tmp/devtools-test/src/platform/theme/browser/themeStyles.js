...
import { colorCssVariable, colorIdentifiers, } from "../common/colorTheme.js";
 ...
 */
export function bindColorTheme(themeService, target) {
    ...
    const apply = (theme) => {
        ...
        target.style.setProperty("color-scheme", isDarkColorScheme(theme.colorScheme) ? "dark" : "light");
