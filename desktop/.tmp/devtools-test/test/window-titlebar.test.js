...
import { defaultWindowState, } from "../src/platform/window/electron-main/window.js";
import { resolveBrowserWindowOptions, } from "../src/platform/windows/electron-main/windows.js";
test("window options apply the custom titlebar host policy", () => {
    ...
    const state = defaultWindowState(2 /* WorkbenchState.FOLDER */);
