use crate::{
    Color, Component, ComponentContext, ComponentElement, CornerRadii, Element, PaintRect, Point,
    Rect, Size, UiScene,
};
...
impl ScrollView {
    ...
    /// Composes scroll content through the shared component frame while retaining the scroll
    /// viewport inspection node and scrollbar paint.
