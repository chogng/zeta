...
pub(crate) const REMOTE_LAUNCH_PROGRESS_ENV: &str = "ZETERM_REMOTE_LAUNCH_PROGRESS";
const REMOTE_LAUNCH_PROGRESS_FORMAT: &str = "json-lines";
const REMOTE_LAUNCH_PROGRESS_PREFIX: &str = "__ZETERM_REMOTE_LAUNCH__:";
...
pub(crate) fn prepare_remote_launch(launch: &mut ZetermLaunch) -> Result<(), String> {
