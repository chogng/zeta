...
const outputFile = resolve(repositoryDirectory, "app/icons/src/generated.rs");
...
export async function syncRustIcons(options: RustIconOptions = {}): Promise<{ readonly count: number; readonly outputFile: string }> {
  ...
  if (mode === "check") {
    ...
    if (current !== generated) {
      throw new Error("Generated Rust product icons are stale. Run 'node build/app/syncRustIcons.ts'.");
    }
