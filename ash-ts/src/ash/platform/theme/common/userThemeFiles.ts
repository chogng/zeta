export const USER_THEME_FILES_LIST_CHANNEL = "ash:user-themes:list";
export const USER_THEME_FILE_WRITE_CHANNEL = "ash:user-themes:write";
export const USER_THEME_FILE_DELETE_CHANNEL = "ash:user-themes:delete";
