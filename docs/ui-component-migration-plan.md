...
本文是 `zui` 组件组合迁移的系统级计划。`zui` 的实现契约见 [`zeterm/crates/zui/README.md`](../zeterm/crates/zui/README.md)，Files/SCM 的产品组件见 [`zeterm/crates/agent-sidebar`](../zeterm/crates/agent-sidebar)。app 宿主的渐进式弃用边界见 [`docs/native-deprecation-plan.md`](native-deprecation-plan.md)。本文拥有跨 crate 的边界、阶段和长期不变量；具体类型细节以源码和 crate README 为准。
