...
> TUI 明确不提供外部 Agent 导入入口：[`zeta-code/docs/design/tui.md`](../zeta-code/docs/design/tui.md)
...
`build/zeta-package/prepareDevPackage.ts` 按 target、JavaScript runtime 与 build profile 组装不可变 debug
